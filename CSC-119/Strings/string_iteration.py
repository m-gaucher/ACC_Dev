...
#print the indexes and their asooicated values using a for loop
...
#print the indexes and their asooicated values using a while loop
...
#print the indexes and their asooicated values using a for loop with range()
...
#print the indexes and their asooicated values using a for loop with enumerate
